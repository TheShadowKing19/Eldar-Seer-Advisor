# Eldar Seer Advisor - A Stellaris Voice Advisor
...
**Eldar Seer Advisor** replaces the standard English advisor with a custom voice pack from Dawn of War II.
...
3.  Extract the contents of the `.zip` file. You will have a folder named `Eldar-Seer-Advisor-[version]`.
4.  Move the folder into your Stellaris mod directory:
...
* **Game Version:** Fully compatible with Stellaris version **4.11.* and later**.
* **Ironman & Achievements:** This mod does not alter gameplay checksums, so it is 100% compatible with Ironman mode and will not prevent you from earning achievements.
...
---
Created by Mikołaj Jóźwik/@TheShadowKing19
